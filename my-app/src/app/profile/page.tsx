              ...
              <div className="flex flex-col gap-1.5 items-center md:items-start">
                ...
                {(city || country) && (
                  <div className="flex items-center gap-1 mt-0.5">
                    <p className="text-neutral-400 text-[10px] md:text-xs bg-black px-2 py-1 w-fit font-bold uppercase">{city}{city && country ? ", " : ""}{country}</p>
                  </div>
                )}
              </div>
            </div>
              ...
              {genre && genre !== "None" && (
                <div className="space-y-1 mt-6 border-t border-zinc-900 pt-4">
                  ...
                  <p className="text-sm font-bold text-white flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-white"></span>{genre}
                  </p>
                </div>
              )}
