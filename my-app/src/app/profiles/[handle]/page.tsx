...
export default function ProfilePage({
  ...
  const renderDetailsPage = () => (
    <div className="container mx-auto px-8 py-10 animate-in fade-in duration-500">
      ...
      {/* Search bar — only for Following / Followers */}
        ...
        {detailTab === "Likes" &&
          (likedTracks.length === 0 ? (
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 w-full max-w-4xl">
              {(likedTracks as TrackShape[]).map((track) => (
                <div key={track.id} className="text-left cursor-pointer group">
                  <div className="aspect-square bg-zinc-800 border border-zinc-700 mb-2 group-hover:border-zinc-600 transition-colors" />
