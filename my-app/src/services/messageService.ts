...
const mockPlaylist: SharedPlaylist = {
  ...
  coverArtUrl: "https://i.scdn.co/image/ab67616d0000b2738b9b1e7a3f7f11f3f4f2d7d9",
  tracksCount: 8,
  tracksPreview: [
    {
      id: "trk_1",
      title: "Panic! At The Disco - House Of Memories",
      slug: "panic-at-the-disco-house-of-memories",
      artist: { id: "usr_q", display_name: "Quality", handle: "quality" },
      coverArtUrl: "/images/track-placeholder.png",
      durationSeconds: 198,
      playCount: 1_110_000,
    },
    {
      id: "trk_2",
      title: "Fall Out Boy - Immortals (Big Hero 6 Druxstep)",
      slug: "fall-out-boy-immortals",
      artist: { id: "usr_d", display_name: "Direx", handle: "direx" },
      coverArtUrl: "/images/track-placeholder.png",
      durationSeconds: 210,
      playCount: 771_000,
    },
    {
      id: "trk_3",
      title: "Adam Lambert - Runnin'",
      slug: "adam-lambert-runnin",
      artist: {
        id: "usr_f",
        display_name: "Feeling The Music",
        handle: "feeling-the-music",
      },
      coverArtUrl: "/images/track-placeholder.png",
      durationSeconds: 205,
      playCount: 405_000,
    ...
    {
      id: "trk_4",
      title: "Fall Out Boy - Immortals (Baymax Remix)",
      slug: "fall-out-boy-immortals-baymax-remix",
      artist: { id: "usr_b", display_name: "Baymax", handle: "baymax" },
      coverArtUrl: "/images/track-placeholder.png",
      durationSeconds: 188,
      playCount: 928_000,
    },
...
let mockMessages: Message[] = [
  ...
  },
  {
    ...
    receiverId: "usr_1",
    type: "PLAYLIST_SHARE",
    text: "Module 7: Sets & Playlists\nhttps://soundcloud.com/maryamsol37/sets/testing",
    isRead: true,
